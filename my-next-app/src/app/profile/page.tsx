      ...
      <div className="mx-auto w-100 p-10 rounded-tr-lg ">
        ...
        <div className="text-center">
          ...
          <ul className="flex flex-col items-center space-y-4 italic">
            <li className="my-2"><span className="font-bold"></span> {profile.name}</li>
            <li className="my-2"><span className="font-bold"></span> {profile.email}</li>
            <li className="my-2"><span className="font-bold"></span> {profile.address}</li>
            <li className="my-2"><span className="font-bold"></span> {profile.phone}</li>
